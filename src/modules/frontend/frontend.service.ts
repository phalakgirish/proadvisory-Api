        ...
        var propertyDts = await this.propertyModel.aggregate([
            ...
            },
            {
                $group: {
                  ...
                  noOfBaths:{$first:"$noOfBaths"},
                  carpetArea:{$first:"$carpetArea"},
                  parking:{$first:"$parking"},
                  priceperSqrt:{$first:"$priceperSqrt"},
                  floor:{$first:"$floor"},
                  ...
                  isnewlaunch:{$first:"$isnewlaunch"},
                  isfeature:{$first:"$isfeature"},
                  isverified:{$first:'$isverified'},
                  isforsale:{$first:'$isforsale'},
                  isbalcony:{$first:'$isbalcony'},
                  isunderConstruction:{$first:"$isunderConstruction"},
